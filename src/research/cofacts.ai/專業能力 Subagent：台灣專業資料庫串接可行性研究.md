...
| 資料源 | 內容與接法 | 備註 |
| :---- | :---- | :---- |
| **165 遭停止解析涉詐網站** | [data.gov.tw/dataset/176455](https://data.gov.tw/dataset/176455)，免金鑰 CSV，不定期更新（2026-01 上架）。排程同步後做網址比對工具。 | 舊「假投資(博弈)網站」清單（dataset/160055）已被本資料集取代；**詐騙 LINE ID dataset（78432）已於 2024/11 下架**，若需資料，須正式行文刑事局。165dashboard.tw 本身無文件化 API，不建議爬。另 g0v [Open165 提案](https://g0v.hackmd.io/@mrorz/open165-proposal)（mrorz 發起）有現成資料清洗脈絡，宜先內部討論合作。 |
