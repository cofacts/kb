---
type: Collection
title: "Cofacts 研究文件索引"
resource: "https://g0v.hackmd.io/XExquqWwS6G02ZY07nPCRg"
tags: [cofacts, research]
timestamp: "2026-06-24T00:00:00+08:00"
---

# Cofacts 研究文件（Research Docs）

> [!NOTE]
> Research documents: Collects related works and design alternatives on how a certain requirement can be fulfilled

> [!TIP]
> Latest research docs first

- [中央社 CNA MCP：能力觀察與 cofacts.ai 整合評估](cofacts.ai/中央社%20CNA%20MCP：能力觀察與%20cofacts.ai%20整合評估.md)
...
- [Cofacts preview generation](cofacts-preview-generation.md)
- [CCPRIP](ccprip.md)
- [Cofacts chatbot error analysis 2023/01/21 ~](cofacts-chatbot-error-analysis-2023-01-21.md)
- [Multimedia support](multimedia-support.md)
- [Google Analytics 4 migration](google-analytics-4-migration.md)
- [User Profile Page Pilot Study](user-profile-page-pilot-study.md)
